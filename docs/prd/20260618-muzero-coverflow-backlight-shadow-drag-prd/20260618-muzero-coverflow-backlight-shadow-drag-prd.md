...
|-------|------|--------|------|
| 1 | 观测/复现：harness 记录 `active` / hand-off 状态机的滞留 | 🔲 Pending | [Phase 1 Checklist](#phase-1-checklist) |
| 2 | 修复 #2：同曲（drag 回原点）提交后 hand-off 不卡死、effect 恢复 | 🔲 Pending | [Phase 2 Checklist](#phase-2-checklist) |
| 3 | 修复 #1：拖拽期 backlight（/shadow）不直接消失 | 🔲 Pending | [Phase 3 Checklist](#phase-3-checklist) |
