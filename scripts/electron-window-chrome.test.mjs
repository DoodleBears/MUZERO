...
describe("resolveWindowChrome", () => {
  it("runs the macOS window transparent + framed with native traffic lights", () => {
    ...
    // Keep native traffic lights (top-left) via the inset title bar. (Frameless was
    // tried to fix the transparent-window scroll trails and did NOT help, so the frame
    // is not the cause — macOS keeps its native window controls.)
